...
define('HEADER_TITLE_CATEGORIES','JORDAN');

/*bof manufacturers definitions*/
define('HEADER_TITLE_MANUFACTURERS','Nike air max');

/*bof about us definitions*/
define('HEADER_TITLE_ABOUT_US','NIKE BASKETBALL SHOES');
...
define('HEADER_TITLE_INFORMATION','Nike Free');
